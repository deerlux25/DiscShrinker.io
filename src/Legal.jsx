...
function PrivacyContent() {
  return (
    <>
      ...
      <h2>Other state privacy notices</h2>
      <p>
        Several states have their own comprehensive privacy laws. Most of
        their formal requirements only apply to businesses handling data
        at a certain scale, but we're linking the statutes directly here
        as a courtesy so residents of these states don't have to go
        searching for them:
      </p>
      <ul className="legal-list">
        <li>
          <strong>California</strong> — California Consumer Privacy Act
          (as amended by the CPRA),{" "}
          <a
            href="https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=1798.100&lawCode=CIV"
            target="_blank"
        ...
        <li>
          <strong>Virginia</strong> — Consumer Data Protection Act,{" "}
          <a
        ...
        <li>
          <strong>Colorado</strong> — Colorado Privacy Act,{" "}
          <a
            href="https://law.justia.com/codes/colorado/title-6/fair-trade-and-restraint-of-trade/article-1/part-13/"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <li>
          <strong>Texas</strong> — Texas Data Privacy and Security Act,{" "}
          <a
      ...
      <p>
        Illinois doesn't currently have a general consumer privacy law of
        this kind — its main privacy statute (BIPA) covers biometric data
        specifically (fingerprints, face/voice scans), which this site
        doesn't collect, so it isn't linked here. If you're a resident of
        a state not listed above, the rights described in this policy
